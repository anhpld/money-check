...
type AdminSection = "overview" | "users" | "collections" | "statistics" | "transactions" | "webhooks" | "ai" | "settings";
...
function SidebarIcon({ type }: { type: "grid" | "users" | "wallet" | "swap" | "hook" | "ai" | "settings" }) {
  const paths = {
    ...
    ai: <><path d="m12 3-1.9 5.8a2 2 0 0 1-1.3 1.3L3 12l5.8 1.9a2 2 0 0 1 1.3 1.3L12 21l1.9-5.8a2 2 0 0 1 1.3-1.3L21 12l-5.8-1.9a2 2 0 0 1-1.3-1.3L12 3z" /></>,
    ...
    <div className="admin-shell">
      ...
      <aside className="sidebar">
        ...
        <nav className="main-nav" aria-label="Điều hướng quản trị">
          ...
          <p>HỆ THỐNG</p>
          <Link href="/admin/ai" className={active === "ai" ? "active" : undefined}><SidebarIcon type="ai" />Trợ lý AI</Link>
